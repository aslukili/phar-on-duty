                    ...
                    <div class="mt-7">
                        <form method="post" action="/city-admins" class="max-w-xl mx-auto px-3.5 bg-sky-100 p-7 shadow-lg">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="full_name" name="full_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="John Doe" required>
                            </div>
                            <div class="mb-3">
