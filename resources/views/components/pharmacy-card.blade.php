    ...
    <div class="flex" >
        ...
        <div class=" pt-1.5 pl-3 pb-1.5 pr-3 md:pr-0 md:pl-1.5 flex-grow bg-no-repeat bg-cover bg-center" style="background-image: url('{{asset('/images/logotanja24.jpg')}}')">
            ...
            <div class="flex justify-between items-center text-right mb-1.5 mt-1.5">
                ...
                <button id="btn{{$pharmacy->id}}" onclick="displayMoreInfo({{$pharmacy->id}})" class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 shadow-sm shadow-green-500/50  rounded-md text-sm px-3 py-1 text-center">
                    <i class="fa-solid fa-angles-down"></i>
                    المزيد
                </button>
            </div>
            <div id="{{$pharmacy->id}}" style="display: none">
                <div class="flex items-center justify-end p-6 space-x-2 rounded-b border-t border-gray-200 ">
                    <a href="whatsapp://send?text={{$pharmacy->pharmacy->map_link}}" class="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300  shadow-md shadow-purple-500/50  font-medium rounded-sm text-sm px-1.5 py-1 text-center mr-1.5">مشاركة</a>
                    ...
                    <a href="tel:{{$pharmacy->pharmacy->tel}}" class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 shadow-md shadow-green-500/50  font-medium rounded-sm text-sm px-1.5 py-1 text-center mr-1.5">اتصال</a>
                </div>
