        ...
        <div id="main" class="main-content flex-1 bg-gray-50 pb-24 md:pb-5">
            ...
            <div class="flex flex-wrap">
                <div class="container mx-auto">
                    <div class="mt-7">
                        <form method="post" action="/users/{{$user->id}}" class="max-w-xl mx-auto px-3.5 bg-sky-100 p-7 shadow-lg">
                            @method('PUT')
                            @csrf
                            <div class="mb-3">
                                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 ">nom et prénom</label>
                                <input type="text" id="full_name" name="full_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " value="{{$user->name}}" placeholder="John Doe" required>
                            </div>
                            <div class="mb-3">
                                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 ">email</label>
                                <input type="email" id="email" name="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="name@admin.com" value="{{$user->email}}" required>
                            </div>
                            @error('email')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" id="phone" name="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="name@admin.com" value="{{$user->phone}}" required>
                            </div>
                            <div class="mb-3">
