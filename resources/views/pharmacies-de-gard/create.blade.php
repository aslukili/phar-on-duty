                ...
                <div class="container mx-auto">
                    <div class="mt-7">
                        <form method="post" action="/pharmacie-de-gard" class="max-w-xl mx-auto px-3.5">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="datetime-local" name="open_time" id="open_time" value="2022-07-05T20:00" class="block py-2.5 px-0 w-full text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="datetime-local" name="close_time" id="open_time" value="2022-07-06T09:00" class="block py-2.5 px-0 w-full text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
