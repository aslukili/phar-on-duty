        ...
        <div id="main" class="main-content flex-1 bg-gray-50 pb-24 md:pb-5">
            ...
            <div class="flex flex-wrap">
                <div class="container mx-auto">
                    <div class="mt-7">
                        <form onsubmit="return foo(document.getElementById('open_time'), document.getElementById('close_time'))" method="post" action="/pharmacie-de-gard" class="max-w-xl mx-auto px-3.5">
                            @csrf
                            <input type="hidden" name="city_name_fk" value="<?php echo $_GET['city']?>">
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="datetime-local" name="open_time" id="open_time" value="<?php echo date('Y-m-d')?>T20:30" class="block py-2.5 px-0 w-full text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="datetime-local" name="close_time" id="close_time" value="<?php echo (new DateTime('+1 day'))->format('Y-m-d');?>T09:00" class="block py-2.5 px-0 w-full text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
