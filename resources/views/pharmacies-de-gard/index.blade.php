                ...
                <div class="container mx-auto">
                    <div class="grid md:grid-cols-3 justify-between items-center mt-3.5">
                        <div class="col-span-2 flex items-center gap-3">
                            ...
                            <form class="flex gap-3">
                                ...
                                <div class="flex items-center">
                                    <label for="date" class="">date(ovrir):</label>
                                    <input type="date" name="date" id="date" value="<?php echo date('Y-m-d')?>" class="block p-3 w-full text-md text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                        ...
                        <div class="text-right">
                            <button type="button" class="text-gray-900 bg-gradient-to-r from-lime-200 via-lime-400 to-lime-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-lime-300  font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2" data-modal-toggle="defaultModal">
                            ...
                            <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                                <div class="relative bg-white rounded-lg shadow ">
                                    ...
                                    <form action="/pharmacie-de-gard/create" class="p-6 space-y-6">
                                        <label for="city" class="block mb-1 text-sm font-medium text-gray-900 ">veuillez choisir une ville</label>
                                        <select name="city" id="city" class="block p-3 w-full text-md text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                                            @foreach($cities as $city)
